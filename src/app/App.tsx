...
const tileInfo: {
  ...
  0: {
    ...
    subtitle: "WEB APP",
    description:
      "Real-time analytics dashboard with dynamic charting and interactive data exploration.",
    details: [
  ...
  1: {
    // Tile 2
    title: "ProjecTiles / Demo",
    subtitle: "Streamlined Portfolio System",
    description:
      "Launch-ready landing page template for ProjecTiles, designed for fast customization and publishing.",
    details: [
      "Modular hero, gallery, and feature sections built for quick content swaps.",
      "Visual system with bold typography, mosaic tiles, and motion-ready layout.",
    ],
    techStack: ["Figma", "Codex", "TypeScript"],
    embedUrl: "https://remotelyamused.web.app",
  },
  2: {
    // Tile 3
    title: "Promptly",
    ...
    description:
      "A streamlined interface for drafting and storyboarding prompts.",
    details: [
  ...
  4: {
    ...
    description:
      "Personal wellness companion with habit tracking and health insights.",
    details: [
  ...
  6: {
    ...
    description:
      "Collaborative task management with visual workflow automation.",
    details: [
  ...
  7: {
    ...
    subtitle: "Web Application",
    description:
      "A cinematic prompt studio for generating image sequences and storyboard-ready frames.",
    details: [
  ...
  8: {
    ...
    description:
      "Speech-to-text transcription service with multi-language support.",
    details: [
  ...
  9: {
    ...
    description:
      "Stock market analysis platform with predictive modeling and alerts.",
    details: [
  ...
  10: {
    ...
    description:
      "Carbon footprint calculator with personalized reduction strategies.",
    details: [
  ...
  12: {
    ...
    subtitle: "Security",
    description:
      "Password manager with biometric authentication and secure sharing.",
    details: [
  ...
  13: {
    ...
    description:
      "Adaptive learning platform with personalized course recommendations.",
    details: [
  ...
  14: {
    ...
    description:
      "Batch image optimization and transformation toolkit for developers.",
    details: [
...
export default function App() {
  ...
  const handlePrev = () => {
    if (selectedTile) {
      const prevIndex =
        (selectedTile.index - 1 + tileColors.length) % tileColors.length;
    ...
    <div className="min-h-screen bg-[#0A0A0A] pt-8 md:pt-12 flex flex-col items-center justify-center">
      <div className="w-full max-w-[min(90vh,90vw)] md:max-w-[min(72vh,72vw)] px-4">
        ...
        <p className="text-left mt-6 md:mt-8 text-xs md:text-sm text-white/40 font-mono uppercase tracking-wider">
          <a
            href="mailto:josh@hooloovoocafe.com"
